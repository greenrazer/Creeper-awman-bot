...
class AudioHandler {
  ...
  addToQueue(voiceChannel, nums) {
    ...
    const data = this.idToData.get(this.idFromVoiceChannel(voiceChannel));
    for(let num of nums) {
